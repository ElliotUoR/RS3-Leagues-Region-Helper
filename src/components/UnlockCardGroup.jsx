...
export default function UnlockCardGroup({ parent, related, isUnlocked, hasCrystalGrace }) {
  return (
    <div className="unlock-group">
      <UnlockCard entry={parent} isUnlocked={isUnlocked} hasCrystalGrace={hasCrystalGrace} />
      {related?.length > 0 && (
        <>
          ...
          <div className="unlock-group-children">
            {related.map((child) => (
              <UnlockCard
                ...
                hasCrystalGrace={hasCrystalGrace}
